...
private:
    ...
    std::string get_short_time();
    std::string simplify_cq_codes(const std::string &message, userid_t botqq = 0);
    std::string strip_bot_at(const std::string &message, const msg_meta &conf);
